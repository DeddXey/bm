...
struct tim_t<1>
{
  ...
  constexpr static uint32_t BRK_IRQn =
    24; /*!< TIM1 Break interrupt and TIM9 global interrupt */
  constexpr static uint32_t UP_IRQn =
    25; /*!< TIM1 Update Interrupt and TIM10 global interrupt */
  constexpr static uint32_t TRG_COM_IRQn =
...
struct tim_t<8>
{
  ...
  constexpr static uint32_t BRK_IRQn =
    43; /*!< TIM8 Break interrupt and TIM9 global interrupt */
  constexpr static uint32_t UP_IRQn =
    44; /*!< TIM8 Update Interrupt and TIM10 global interrupt */
  constexpr static uint32_t TRG_COM_IRQn =
    45; /*!< TIM8 Trigger and Commutation Interrupt and TIM11 global interrupt
         */
...
struct Tim
{
...
#ifdef DEBUG
  volatile TimerRegs<num> *volatile debug =
    reinterpret_cast<TimerRegs<num> *volatile>(tim_t<num>::TIM_BASE);
#endif
  ...
  ///
  static volatile TimerRegs<num> *rg()
  {
    return reinterpret_cast<volatile TimerRegs<num> *volatile>(
      tim_t<num>::TIM_BASE);
  }
                                 ...
                                 uint32_t subPriority)
  {
    ...
    Nvic::setPriority(static_cast<Nvic::IrqType>(tim_t<num>::UP_IRQn),
                      preemptPriority); // TODO:
  ...
  static void enableUpdateDma(bool en)
  {
    rg()->DIER.UDE = en;
  }
