...
struct Scb {
    ...
    struct CFSR_UFSR_BFSR_MMFSR {
        ...
        constexpr static uint8_t MUNSTKERR[]{3,
                                             1};    //< Memory manager fault on unstacking for a return from exception
    ...
    static uint16_t getCpuidImplementer() { return tl::getRegField(rg()->CPUID, CPUID::Implementer); }

    static uint16_t getCpuidVariant() { return tl::getRegField(rg()->CPUID, CPUID::Variant); }

    static uint16_t getCpuidConstant() { return tl::getRegField(rg()->CPUID, CPUID::Constant); }

    static uint16_t getCpuidPartNo() { return tl::getRegField(rg()->CPUID, CPUID::PartNo); }

    static uint16_t getCpuidRevision() { return tl::getRegField(rg()->CPUID, CPUID::Revision); }


    static uint16_t getUfDivByZero() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::DIVBYZERO);
    }

    static uint16_t getUfUnaligned() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::UNALIGNED);
    }

    static uint16_t getUfNoCoprocessor() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::NOCP);
    }

    static uint16_t getUfInvalidPc() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::INVPC);
    }

    static uint16_t getUfInvalidState() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::INVSTATE);
    }

    static uint16_t getUfUndefinedInstruction() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::UNDEFINSTR);
    }

    static uint16_t getBfValid() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::BFARVALID);
    }

    static uint16_t getBfFpLazyState() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::LSPERR);
    }

    static uint16_t getBfStacking() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::STKERR);
    }

    static uint16_t getBfUnStacking() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::UNSTKERR);
    }

    static uint16_t getBfImprecise() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::IMPRECISERR);
    }

    static uint16_t getBfPrecise() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::PRECISERR);
    }

    static uint16_t getBfInstruction() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::IBUSERR);
    }

    static uint16_t getMfValid() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::MMARVALID);
    }

    static uint16_t getMfFpLazyState() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::MLSPERR);
    }

    static uint16_t getMfStacking() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::MSTKERR);
    }

    static uint16_t getMfUnStacking() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::MUNSTKERR);
    }

    static uint16_t getMfDataAccess() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::DACCVIOL);
    }

    static uint16_t getMfInstructionAccess() {
        return tl::getRegField(rg()->CFSR_UFSR_BFSR_MMFSR, CFSR_UFSR_BFSR_MMFSR::IACCVIOL);
    }

    static uint16_t getHfVectorTable() { return tl::getRegField(rg()->HFSR, HFSR::VECTTBL); }

    static uint16_t getHfForsed() { return tl::getRegField(rg()->HFSR, HFSR::FORCED); }

    static uint16_t getHfDebug() { return tl::getRegField(rg()->HFSR, HFSR::DEBUG_VT); }


    static uint32_t getMemoryFaultAddress() { return (rg()->MMFAR); }

    static uint32_t getBusFaultAddress() { return (rg()->BFAR); }

    static void enableSeparatedFaults(const bool bus, const bool memory, const bool usage) {
        tl::setRegister(rg()->SHCSR,
                        SHCSR::BUSFAULTENA, bus,
                        SHCSR::MEMFAULTENA, memory,
                        SHCSR::USGFAULTENA, usage);
    }

    static void enableTraps(const bool divByZero, const bool unaligned) {
        tl::setRegister(rg()->CCR,
