...
struct Rcc
{
  ...
  struct Regs
  {
    ...
    uint32_t AHB1LPENR; //< 0x50 AHB1 peripheral clock enable in low power mode
                        //register
    uint32_t AHB2LPENR; //< 0x54 AHB2 peripheral clock enable in low power mode
                        //register
    uint32_t AHB3LPENR; //< 0x58 AHB3 peripheral clock enable in low power mode
                        //register
    uint32_t reserved4; //< reserved
    uint32_t APB1LPENR; //< 0x60 APB1 peripheral clock enable in low power mode
                        //register
    uint32_t APB2LPENR; //< 0x64 APB2 peripheral clock enabled in low power mode
                        //register
  ...
  struct CR
  {
    ...
    constexpr static uint8_t PLLRDY[]{ 25,
                                       1 }; //< Main PLL (PLL) clock ready flag
  ...
  struct PLLCFGR
  {
    constexpr static uint8_t PLLQ[]{
      24,
      4
    }; //< Main PLL (PLL) division factor for USB OTG FS, SDIO and random number
       //generator clocks
    constexpr static uint8_t PLLSRC[]{
      22,
      1
    }; //< Main PLL(PLL) and audio PLL (PLLI2S) entry clock source
    constexpr static uint8_t PLLP[]{
      16,
      2
    }; //< Main PLL (PLL) division factor for main system clock
    constexpr static uint8_t PLLN[]{
      6,
      9
    }; //< Main PLL (PLL) multiplication factor for VCO
    constexpr static uint8_t PLLM[]{
      0,
      6
  ...
  struct CFGR
  {
    ...
    constexpr static uint8_t RTCPRE[]{
      16,
      5
    }; //< HSE division factor for RTC clock
    constexpr static uint8_t PPRE2[]{ 13,
                                      3 }; //< APB high-speed prescaler (APB2)
    constexpr static uint8_t PPRE1[]{ 10,
                                      3 };   //< APB Low speed prescaler (APB1)
  ...
  struct CIR
  {
    ...
    constexpr static uint8_t PLLI2SRDYC[]{ 21,
                                           1 }; //< PLLI2S ready interrupt clear
    constexpr static uint8_t PLLRDYC[]{
      20,
      1
    ...
    constexpr static uint8_t PLLI2SRDYIE[]{
      13,
      1
    }; //< PLLI2S ready interrupt enable
    constexpr static uint8_t PLLRDYIE[]{
      12,
      1
    ...
    constexpr static uint8_t PLLI2SRDYF[]{ 5,
                                           1 }; //< PLLI2S ready interrupt flag
    constexpr static uint8_t PLLRDYF[]{
      4,
      1
  ...
  struct AHB2RSTR
  {
    ...
    constexpr static uint8_t RNGRST[]{
      6,
      1
  ...
  struct AHB3RSTR
  {
    constexpr static uint8_t FMCRST[]{
      0,
      1
  ...
  struct AHB1ENR
  {
    constexpr static uint8_t OTGHSULPIEN[]{ 30,
                                            1 }; //< USB OTG HSULPI clock enable
    constexpr static uint8_t OTGHSEN[]{ 29, 1 }; //< USB OTG HS clock enable
    constexpr static uint8_t ETHMACPTPEN[]{ 28,
                                            1 }; //< Ethernet PTP clock enable
    constexpr static uint8_t ETHMACRXEN[]{
      27,
      1
    }; //< Ethernet Reception clock enable
    constexpr static uint8_t ETHMACTXEN[]{
      26,
      1
    ...
    constexpr static uint8_t CCMDATARAMEN[]{ 20,
                                             1 }; //< CCM data RAM clock enable
    constexpr static uint8_t BKPSRAMEN[]{
      18,
      1
  ...
  struct AHB3ENR
  {
    constexpr static uint8_t FMCEN[]{
      0,
      1
  ...
  struct APB2ENR
  {
    ...
    constexpr static uint8_t SYSCFGEN[]{
      14,
      1
  ...
  struct AHB1LPENR
  {
    constexpr static uint8_t GPIOALPEN[]{
      0,
      1
    }; //< IO port A clock enable during sleep mode
    constexpr static uint8_t GPIOBLPEN[]{
      1,
      1
    }; //< IO port B clock enable during Sleep mode
    constexpr static uint8_t GPIOCLPEN[]{
      2,
      1
    }; //< IO port C clock enable during Sleep mode
    constexpr static uint8_t GPIODLPEN[]{
      3,
      1
    }; //< IO port D clock enable during Sleep mode
    constexpr static uint8_t GPIOELPEN[]{
      4,
      1
    }; //< IO port E clock enable during Sleep mode
    constexpr static uint8_t GPIOFLPEN[]{
      5,
      1
    }; //< IO port F clock enable during Sleep mode
    constexpr static uint8_t GPIOGLPEN[]{
      6,
      1
    }; //< IO port G clock enable during Sleep mode
    constexpr static uint8_t GPIOHLPEN[]{
      7,
      1
    }; //< IO port H clock enable during Sleep mode
    constexpr static uint8_t GPIOILPEN[]{
      8,
      1
    }; //< IO port I clock enable during Sleep mode
    constexpr static uint8_t CRCLPEN[]{
      12,
      1
    }; //< CRC clock enable during Sleep mode
    constexpr static uint8_t FLITFLPEN[]{
      15,
      1
    }; //< Flash interface clock enable during Sleep mode
    constexpr static uint8_t SRAM1LPEN[]{
      16,
      1
    }; //< SRAM 1interface clock enable during Sleep mode
    constexpr static uint8_t SRAM2LPEN[]{
      17,
      1
    }; //< SRAM 2 interface clock enable during Sleep mode
    constexpr static uint8_t BKPSRAMLPEN[]{
      18,
      1
    }; //< Backup SRAM interface clock enable during Sleep mode
    constexpr static uint8_t DMA1LPEN[]{
      21,
      1
    }; //< DMA1 clock enable during Sleep mode
    constexpr static uint8_t DMA2LPEN[]{
      22,
      1
    }; //< DMA2 clock enable during Sleep mode
    constexpr static uint8_t ETHMACLPEN[]{
      25,
      1
    }; //< Ethernet MAC clock enable during Sleep mode
    constexpr static uint8_t ETHMACTXLPEN[]{
      26,
      1
    }; //< Ethernet transmission clock enable during Sleep mode
    constexpr static uint8_t ETHMACRXLPEN[]{
      27,
      1
    }; //< Ethernet reception clock enable during Sleep mode
    constexpr static uint8_t ETHMACPTPLPEN[]{
      28,
      1
    }; //< Ethernet PTP clock enable during Sleep mode
    constexpr static uint8_t OTGHSLPEN[]{
      29,
      1
    }; //< USB OTG HS clock enable during Sleep mode
    constexpr static uint8_t OTGHSULPILPEN[]{
      30,
      1
  ...
  struct AHB2LPENR
  {
    constexpr static uint8_t OTGFSLPEN[]{
      7,
      1
    }; //< USB OTG FS clock enable during Sleep mode
    constexpr static uint8_t RNGLPEN[]{
      6,
      1
    }; //< Random number generator clock enable during Sleep mode
    constexpr static uint8_t HASHLPEN[]{
      5,
      1
    }; //< Hash modules clock enable during Sleep mode
    constexpr static uint8_t CRYPLPEN[]{
      4,
      1
    }; //< Cryptography modules clock enable during Sleep mode
    constexpr static uint8_t DCMILPEN[]{
      0,
      1
  ...
  struct AHB3LPENR
  {
    constexpr static uint8_t FMCLPEN[]{
      0,
      1
  ...
  struct APB1LPENR
  {
    constexpr static uint8_t TIM2LPEN[]{
      0,
      1
    }; //< TIM2 clock enable during Sleep mode
    constexpr static uint8_t TIM3LPEN[]{
      1,
      1
    }; //< TIM3 clock enable during Sleep mode
    constexpr static uint8_t TIM4LPEN[]{
      2,
      1
    }; //< TIM4 clock enable during Sleep mode
    constexpr static uint8_t TIM5LPEN[]{
      3,
      1
    }; //< TIM5 clock enable during Sleep mode
    constexpr static uint8_t TIM6LPEN[]{
      4,
      1
    }; //< TIM6 clock enable during Sleep mode
    constexpr static uint8_t TIM7LPEN[]{
      5,
      1
    }; //< TIM7 clock enable during Sleep mode
    constexpr static uint8_t TIM12LPEN[]{
      6,
      1
    }; //< TIM12 clock enable during Sleep mode
    constexpr static uint8_t TIM13LPEN[]{
      7,
      1
    }; //< TIM13 clock enable during Sleep mode
    constexpr static uint8_t TIM14LPEN[]{
      8,
      1
    }; //< TIM14 clock enable during Sleep mode
    constexpr static uint8_t WWDGLPEN[]{
      11,
      1
    }; //< Window watchdog clock enable during Sleep mode
    constexpr static uint8_t SPI2LPEN[]{
      14,
      1
    }; //< SPI2 clock enable during Sleep mode
    constexpr static uint8_t SPI3LPEN[]{
      15,
      1
    }; //< SPI3 clock enable during Sleep mode
    constexpr static uint8_t USART2LPEN[]{
      17,
      1
    }; //< USART2 clock enable during Sleep mode
    constexpr static uint8_t USART3LPEN[]{
      18,
      1
    }; //< USART3 clock enable during Sleep mode
    constexpr static uint8_t UART4LPEN[]{
      19,
      1
    }; //< UART4 clock enable during Sleep mode
    constexpr static uint8_t UART5LPEN[]{
      20,
      1
    }; //< UART5 clock enable during Sleep mode
    constexpr static uint8_t I2C1LPEN[]{
      21,
      1
    }; //< I2C1 clock enable during Sleep mode
    constexpr static uint8_t I2C2LPEN[]{
      22,
      1
    }; //< I2C2 clock enable during Sleep mode
    constexpr static uint8_t I2C3LPEN[]{
      23,
      1
    }; //< I2C3 clock enable during Sleep mode
    constexpr static uint8_t CAN1LPEN[]{
      25,
      1
    }; //< CAN 1 clock enable during Sleep mode
    constexpr static uint8_t CAN2LPEN[]{
      26,
      1
    }; //< CAN 2 clock enable during Sleep mode
    constexpr static uint8_t PWRLPEN[]{
      28,
      1
    }; //< Power interface clock enable during Sleep mode
    constexpr static uint8_t DACLPEN[]{
      29,
      1
  ...
  struct APB2LPENR
  {
    constexpr static uint8_t TIM1LPEN[]{
      0,
      1
    }; //< TIM1 clock enable during Sleep mode
    constexpr static uint8_t TIM8LPEN[]{
      1,
      1
    }; //< TIM8 clock enable during Sleep mode
    constexpr static uint8_t USART1LPEN[]{
      4,
      1
    }; //< USART1 clock enable during Sleep mode
    constexpr static uint8_t USART6LPEN[]{
      5,
      1
    }; //< USART6 clock enable during Sleep mode
    constexpr static uint8_t ADC1LPEN[]{
      8,
      1
    }; //< ADC1 clock enable during Sleep mode
    constexpr static uint8_t ADC2LPEN[]{
      9,
      1
    }; //< ADC2 clock enable during Sleep mode
    constexpr static uint8_t ADC3LPEN[]{
      10,
      1
    }; //< ADC 3 clock enable during Sleep mode
    constexpr static uint8_t SDIOLPEN[]{
      11,
      1
    }; //< SDIO clock enable during Sleep mode
    constexpr static uint8_t SPI1LPEN[]{
      12,
      1
    }; //< SPI 1 clock enable during Sleep mode
    constexpr static uint8_t SYSCFGLPEN[]{
      14,
      1
    }; //< System configuration controller clock enable during Sleep mode
    constexpr static uint8_t TIM9LPEN[]{
      16,
      1
    }; //< TIM9 clock enable during sleep mode
    constexpr static uint8_t TIM10LPEN[]{
      17,
      1
    }; //< TIM10 clock enable during Sleep mode
    constexpr static uint8_t TIM11LPEN[]{
      18,
      1
  ...
  struct CSR
  {
    ...
    constexpr static uint8_t WDGRSTF[]{ 29,
                                        1 }; //< Independent watchdog reset flag
  ...
  struct SSCGR
  {
    constexpr static uint8_t SSCGEN[]{
      31,
      1
  ...
  struct PLLI2SCFGR
  {
    constexpr static uint8_t PLLI2SR[]{
      28,
      3
    }; //< PLLI2S division factor for I2S clocks
    constexpr static uint8_t PLLI2SQ[]{
      24,
      4
    }; //< PLLI2S division factor for SAI1 clock
    constexpr static uint8_t PLLI2SN[]{
      6,
      9
  ...
  struct PLLSAICFGR
  {
    constexpr static uint8_t PLLSAIR[]{
      28,
      3
    }; //< PLLSAI division factor for LCD clock
    constexpr static uint8_t PLLSAIQ[]{
      24,
      4
    }; //< PLLSAI division factor for SAI1 clock
    constexpr static uint8_t PLLSAIN[]{ 6,
                                        9 }; //< PLLSAI division factor for VCO
  };

  struct DCKCFGR
  {
    constexpr static uint8_t PLLI2SDIVQ[]{
      0,
      5
    }; //< PLLI2S division factor for SAI1 clock
    constexpr static uint8_t PLLSAIDIVQ[]{
      8,
      5
    }; //< PLLSAI division factor for SAI1 clock
    constexpr static uint8_t PLLSAIDIVR[]{ 16,
                                           2 }; //< division factor for LCD_CLK
    constexpr static uint8_t SAI1ASRC[]{ 20,
                                         2 }; //< SAI1-A clock source selection
    constexpr static uint8_t SAI1BSRC[]{ 22,
                                         2 }; //< SAI1-B clock source selection
    constexpr static uint8_t TIMPRE[]{
      24,
      1
  ...
  {
    tl::setRegister(rg()->CFGR, CFGR::HPRE,
  ...
  static void clockOtgHsUlpi(bool en)
  {
  ...
  static void clockCcmdataram(bool en)
  {
    tl::setRegister(rg()->AHB1ENR, AHB1ENR::CCMDATARAMEN, en);
  }
  static void clockBkpsram(bool en)
  {
  ...
  static void clockI2c3(bool en)
  {
    tl::setRegister(rg()->APB1ENR, APB1ENR::I2C3EN, en);
  }
  static void clockCan1(bool en)
  {
    tl::setRegister(rg()->APB1ENR, APB1ENR::CAN1EN, en);
  }
  static void clockCan2(bool en)
  {
  ...
  static void resetUart2(bool en)
  {
    tl::setRegister(rg()->APB1RSTR, APB1RSTR::UART2RST, en);
  }
  static void resetUart3(bool en)
  {
  ...
  static void resetSyscfg(bool en)
  {
