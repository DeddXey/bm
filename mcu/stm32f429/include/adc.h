...
struct Adc
{
  ...
  /// \return указатель на регистры
  ///
  static volatile CommonRegs *commonRg()
  {
  ...
  static void startRegular()
  {
    rg()->CR2.SWSTART = 1;
  }

  static bool endOfConversion()
  {
    return rg()->SR.EOC;
  }
  ...
  static void setChannel(uint8_t sequence, uint8_t channel)
  {
  ...
  static void setConversionLengtht(uint8_t lenght)
  {
  ...
  static void clearEocInterruptFlag()
  {
    rg()->SR.EOC = 0;
  }

  static bool eocInterruptFlag()
  {
    return (rg()->SR.EOC == 1);
  }

  static void setResolution(AdcResolution resolution = ar12bit)
  {
    rg()->CR1.RES = resolution;
  }

  static void setEvent(AdcEvent event)
  {
    rg()->CR2.EXTSEL = event;
  }
};
