...
public:
	...
	static void init()
	{
		...
		I::SpiDmaStream::setPeripheralAddress(reinterpret_cast<uint32_t>(I::SpiP::getDrAddress()));
...
//		I::ExtiDrdy::setMask(true);
	...
	{
		return DmaController<I::spiDmaNumber>::getTransferCompleteFlag(I::spiDmaStream);
	}
	...
	{
		volatile uint16_t stub = I::SpiP::rg()->DR.DR; (void)stub;
	}
	...
	INLINE static void ads1278Sync(bool value)
	{
...
//		simpleDelay(1000);
	...
	static void setFormat(const Ads1278Format format)
	{
		...
		Gpio<I::formatPort>::setOut((format8 & 0b010), I::formatPin1);
		Gpio<I::formatPort>::setOut((format8 & 0b100), I::formatPin2);
	}
	...
	static void setMode(const Ads1278Mode mode)
	{
		...
		Gpio<I::modePort>::setOut((mode8 & 0b10), I::modePin1);
	}
